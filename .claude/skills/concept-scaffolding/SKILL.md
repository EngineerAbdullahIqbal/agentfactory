...
**Complements**: `learning-objectives` (which defines outcomes) + `exercise-pack` (which creates practice exercises)
...
- **→ concept-scaffolding**: Use for chapter-level decisions about WHEN to teach concepts
